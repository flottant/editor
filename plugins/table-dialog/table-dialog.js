...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var path        = settings.path + "https://cdn.jsdelivr.net/gh/flottant/editor/plugins/" + pluginName +"/";
	...
	else if (typeof define === "function")  // AMD/CMD/Sea.js
    {
		if (define.amd) { // for Require.js
			...
			define(function(require) {
                var editormd = require("./https://cdn.jsdelivr.net/gh/flottant/editor/https://cdn.jsdelivr.net/gh/flottant/editor/editormd");
                factory(editormd);
            });
		}
	} 
