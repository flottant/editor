...
(function() {
  ...
  MT('bqhttps://cdn.jsdelivr.net/gh/flottant/editorThenParagraph',
      '[bracket bqhttps://cdn.jsdelivr.net/gh/flottant/editor foo bar]',
      '',
      '[bracket More quote.]',
      'p. Normal Text');

  MT('bqhttps://cdn.jsdelivr.net/gh/flottant/editorThenH1',
      '[bracket bqhttps://cdn.jsdelivr.net/gh/flottant/editor foo bar]',
      '',
      '[bracket More quote.]',
      '[header&header-1 h1. Header Text]');

  MT('bchttps://cdn.jsdelivr.net/gh/flottant/editorThenParagraph',
      '[atom bchttps://cdn.jsdelivr.net/gh/flottant/editor # Some ruby code]',
      '[atom obj = {foo: :bar}]',
      '[atom puts obj]',
      '',
      '[atom obj[[:love]] = "*love*"]',
  ...
  MT('fn1https://cdn.jsdelivr.net/gh/flottant/editorThenParagraph',
      '[variable fn1https://cdn.jsdelivr.net/gh/flottant/editor foo bar]',
      '',
      '[variable More.]',
      'p. Normal Text');

  MT('prehttps://cdn.jsdelivr.net/gh/flottant/editorThenParagraph',
      '[operator prehttps://cdn.jsdelivr.net/gh/flottant/editor foo bar]',
      '',
      '[operator More.]',
      'p. Normal Text');
  ...
  MT('notextileWithSpanningPre',
      '[operator prehttps://cdn.jsdelivr.net/gh/flottant/editor *No* formatting]',
      '',
